...
class CommentControllerTest {
    ...
    private List<Comment> generateComments() {
        ...
        Comment comment1 = new Comment(1L, new CommentContent("1"), post, user);
        comment1.updateAsRoot();
        Comment comment2 = new Comment(2L, new CommentContent("2"), post, user);
        comment2.updateAsRoot();
        Comment comment3 = new Comment(3L, new CommentContent("3"), post, user);
        comment3.updateAsRoot();
        Comment child1 = new Comment(4L, new CommentContent("c1"), post, user);
        Comment child2 = new Comment(5L, new CommentContent("c2"), post, user);
        Comment child3 = new Comment(6L, new CommentContent("c3"), post, user);
        Comment child4 = new Comment(7L, new CommentContent("c4"), post, user);
        Comment child5 = new Comment(8L, new CommentContent("c5"), post, user);
